...
extern bool DFA_execute(DFA dfa, char *input);
 //after setting up specific transistions and setting acceptance states
 //loop through *input by looking at each char, and get transistion for char
 //keep going until you are through the entire string then check acceptance.
/**
